        ...
        try {
            ...
            this.oauth2Client.on('tokens', async (tokens) => {
                ...
                if (tokens.refresh_token || tokens.access_token) {
                    try {
                        await integrationTokenService.saveToken('google_drive', (tokens.refresh_token || tokenData?.refreshToken || ''), tokens.access_token ?? undefined, tokens.expiry_date ? new Date(tokens.expiry_date) : undefined);
