  ...
  return (
    <div className="max-w-2xl mx-auto text-center space-y-8">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl sm:text-3xl font-semibold text-pink-600">
          ¡Próximamente!
        </h2>
        <p className="text-gray-600 text-lg">
          Estamos trabajando en nuestro sistema de reservas en línea para brindarte una mejor experiencia.
        </p>
